...
const PLANS = [
  {
    ...
    badge: null,
    features: [
      { text: '5 questions par partie', ok: true },
      { text: 'Mode Buzz', ok: true },
      { text: 'Mode QCM', ok: false },
      { text: "Jusqu'à 5 joueurs", ok: true },
      { text: 'Questions prédéfinies', ok: true },
  ...
  },
  {
    ...
    features: [
      ...
      { text: 'Mode Buzz', ok: true },
      { text: 'Mode QCM', ok: true },
      { text: "Jusqu'à 20 joueurs", ok: true },
      { text: 'Questions prédéfinies (100+)', ok: true },
      { text: 'Créateur de quiz perso', ok: false },
      { text: 'Support prioritaire', ok: false },
    ],
  ...
  },
  {
    ...
    period: 'par mois',
    accent: '#00E5D1',
    accentLight: 'rgba(0,229,209,0.12)',
    accentBorder: 'rgba(0,229,209,0.4)',
    badge: 'All-inclusive',
    features: [
      { text: 'Questions illimitées', ok: true },
      { text: 'Mode Buzz', ok: true },
      { text: 'Mode QCM', ok: true },
      { text: "Jusqu'à 50 joueurs", ok: true },
      { text: 'Questions prédéfinies (100+)', ok: true },
      ...
      <div className="max-w-2xl mx-auto mt-14">
        ...
        <div className="flex flex-col gap-4">
          {[
            ...
            {
              q: "Combien de joueurs peuvent rejoindre une salle ?",
              a: "5 joueurs avec la formule Découverte, 20 avec Essentiel, et jusqu'à 50 avec la formule Pro.",
            },
            {
              q: "Le créateur de quiz, ça fonctionne comment ?",
              a: "Avec la formule Pro, vous créez vos propres questions (Buzz ou QCM), les organisez en catégories et les réutilisez dans n'importe quelle salle.",
            },
          ].map((item, i) => (
